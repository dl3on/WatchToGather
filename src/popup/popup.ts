...
const confirmCreateBtn = document.getElementById("confirmCreate") as HTMLButtonElement;
const roomTitleInput = document.getElementById("roomTitle") as HTMLInputElement;
const webpageLinkInput = document.getElementById("webpageLink") as HTMLInputElement;
